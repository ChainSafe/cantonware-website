            ...
            <details>
              ...
              <div style={{ padding: '1rem' }}>
                <ul style={{ fontSize: '0.9rem', lineHeight: '1.8' }}>
                  <li><code>testBondSwap</code> - Simple two-party bond exchange ✅</li>
                  <li><code>testMultiAssetSwap</code> - 2-for-1 multi-asset swap ✅</li>
                  <li><code>testSwapModification</code> - Update and cancel proposals ✅</li>
                  <li><code>testSwapDispute</code> - Dispute resolution workflow ✅</li>
                </ul>
...
-- All tests passing. Production-ready.`,
                  ...
                  [
                    ...
                    '<strong>Compiled with DAML SDK</strong> → 0 syntax errors',
                    'Ran <strong>4 test scenarios</strong> with Canton → all passing',
            ...
            <details>
              ...
              <div style={{ padding: '1rem' }}>
                <ul style={{ fontSize: '0.9rem', lineHeight: '1.8' }}>
                  ...
                  <li><code>testBondLifecycle</code> - Full lifecycle: issue → coupon → trade → coupon</li>
                </ul>
...
-- All lifecycle tests passing. Production-ready.`,
                  ...
                  [
                    ...
                    '<strong>Compiled with DAML SDK</strong> → 0 syntax errors',
                    'Ran <strong>2 test scenarios</strong> (setup + full lifecycle) → all passing',
        ...
        <section id="asset-option" style={{ marginTop: '3rem' }}>
          <article className="demo-card">
            ...
            <div className="grid" style={{ marginBottom: '1rem' }}>
              <div>
                <strong>✓ Strike Price Control</strong>
                <p style={{ fontSize: '0.9rem', margin: '0.25rem 0 0 0' }}>
              ...
              <div>
                <strong>✓ Exercise & Settlement</strong>
                <p style={{ fontSize: '0.9rem', margin: '0.25rem 0 0 0' }}>
  ...
  exerciseCmd exerciseCid SettleExercise with
    assetContractId = "BOND-CONTRACT-123"`}</code></pre>
            ...
            <details>
              ...
              <div style={{ padding: '1rem' }}>
                <ul style={{ fontSize: '0.9rem', lineHeight: '1.8' }}>
                  <li><code>setup</code> - Basic option creation and acceptance ✅</li>
                  <li><code>testOptionExercise</code> - Full exercise and settlement workflow ✅</li>
                  <li><code>testOptionExpiry</code> - Expiry enforcement validation ✅</li>
                  <li><code>testOptionPortfolio</code> - Multiple options management ✅</li>
                </ul>
                <pre style={{ fontSize: '0.85rem', marginTop: '0.5rem' }}><code>{`daml script --dar .daml/dist/*.dar \\
...
-- All test scenarios passing. Production-ready.`,
                  ...
                  [
                    ...
                    '<strong>Compiled with DAML SDK</strong> → 0 syntax errors',
                    'Ran <strong>4 test scenarios</strong> (exercise, expiry, portfolio) → all passing',
